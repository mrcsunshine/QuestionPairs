...
class QACNN(object):
    def __init__(
      ...
      filter_sizes, num_filters, l2_reg_lambda=0.0):
        ...
        # 用户问题,字向量使用embedding_lookup
        # self.input_x_1 = tf.placeholder(tf.float32, [batch_size, sequence_length,embedding_size], name="input_x_1")
        # 待匹配正向问题
        # self.input_x_2 = tf.placeholder(tf.float32, [batch_size, sequence_length,embedding_size], name="input_x_2")
        # 负向问题
        # self.input_x_3 = tf.placeholder(tf.float32, [batch_size, sequence_length,embedding_size], name="input_x_3")
        ...
        with tf.device('/cpu:0'), tf.name_scope("embedding"):
            ...
            # print(chars_1)
            # print('emdedding return:'+str(chars_1.get_shape()))
        ...
        # print('emdedding return:'+str(self.embedded_chars_expanded_1.get_shape()))
        # print('input size:'+str(self.input_x_1.get_shape()))
        # self.embedded_chars_expanded_1 = tf.expand_dims(self.input_x_1, -1)
        # self.embedded_chars_expanded_2 = tf.expand_dims(self.input_x_2, -1)
        # self.embedded_chars_expanded_3 = tf.expand_dims(self.input_x_2, -1)
        # print('input size:'+str(self.embedded_chars_expanded_1.get_shape()))
        pooled_outputs_1 = []
        pooled_outputs_2 = []
        pooled_outputs_3 = []
